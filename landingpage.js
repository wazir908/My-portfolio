...
const SocialMediaPopup = ({ onClose }) => {
  const socialMediaLinks = [
    { icon: <FaFacebook />, url: 'https://www.facebook.com/profile.php?id=100080757323291' },
    { icon: <FaInstagram />, url: 'https://instagram.com/waxirmubashir_786?utm_source=qr&igshid=NGExMmI2YTkyZg%3D%3D' },
    { icon: <FaGithub />, url: 'https://github.com/example' },
    { icon: <FaLinkedin />, url: 'https://www.linkedin.com/in/wazir-mubashir-379b28279/' },
    { icon: <FaEnvelope />, url: 'mailto:wazirmubashir2021@gmail.com' },
    { icon: <FaPhone />, url: 'tel:+923469657528' },
    { icon: <FaWhatsapp />, url: 'https://wa.me/+923469657528' }, 
  ];
            ...
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                ...
                <span
                  ref={typedRef}
                  className="typed"
                  data-typed-items="React JS Developer , Shopify Developer"
                ></span>
              </p>
